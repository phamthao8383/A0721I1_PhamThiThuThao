...
<header>
	<img src="/static/images/footads-new.png" alt="" width="100%" height="100px">
</header>
				...
				<div class="input-group">
					<form action="/product/list-by-keywords" method="post">
						...
						<div class="input-group-append">
							<button class="btn btn-secondary" value="${param.keywords}" type="submit" style="background-color: #003333; border: none; width: 50px; height: 34px">
								...
								<div class="card-sp">
									<ul>
										<li>
											...
											<p class="carts"><a href="/cart/view" style="text-decoration: none; color: #003333">Giỏ hàng</a></p>
											<ul>
												<li>
													<div class="row">
														<c:choose>
