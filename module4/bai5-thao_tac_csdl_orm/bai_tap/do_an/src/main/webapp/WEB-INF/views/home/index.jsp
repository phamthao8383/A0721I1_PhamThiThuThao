...
<c:set var="cart" value="${sessionScope['scopedTarget.cartService']}" />
              ...
              <div id="demo" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="carousel-item active">
						<img src="/static/images/slideshow/sline5.png" alt="Los Angeles" width="100%" height="342px">
					</div>
	...
	<div class="row">
	     <div class="col-3"><br><img src="/static/images/dt7.png" width="100%" height="150px" /></div>
	     <div class="col-3"><br><img src="/static/images/dt6.png" width="100%" height="150px" /></div>
	     <div class="col-3"><br><img src="/static/images/dt5.png" width="100%" height="150px" /></div>
	      <div class="col-3"><br><img src="/static/images/dt4.png" width="100%" height="150px" /></div>
	</div>
	...
	<div class="gia-soc" style="margin-top: 30px">
		<div style="background-color: #003333; width: 100.1%; margin-left: -1px; height: 65px; margin-top: -10px; font-weight: bold; padding: 13px">
	...
	<br> <img src="/static/images/slideshow/hotsale-iphone-xr-1006-v2-0.gif" width="100%" height="150px" />

	
	
	<div class="gia-soc" style="margin-top: 30px">
		<div
			style="background-color: #003333; width: 100%; height: 65px; margin-top: -10px; font-weight: bold; padding: 13px">
	...
	<div class="row">
	     <div class="col-6"><br><img src="/static/images/anhqc1.jpg" width="100%" height="150px"/></div>
	     <div class="col-6"><br><img src="/static/images/anhqc2.jpg" width="100%" height="150px" /></div>
	</div>
	...
	<div class="gia-soc" style="margin-top: 30px">
		<div
			style="background-color: #003333; width: 100%; height: 65px; margin-top: -10px; font-weight: bold; padding: 13px">
			<span style="color: #fff; text-align: left; font-size: 26px;">SẢN PHẨM YÊU THÍCH</span> 
			<span style="color: #fff; float: right; font-size: 16px; padding: 8px;">
			<a href="/product/list-by-new/0" style="color: #fff; text-decoration: none;"> Xem tất cả</a></span>
		</div>
		<div class="row"
